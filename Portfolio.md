...
- **Interoperable:** Data uses tabular CSV with consistent sample IDs (`mpa411_` prefix). Taxonomic strings follow MetaPhlAn 4 conventions. Recommendation: provide JSON/Parquet versions and explicit data dictionaries.
...
- **Privacy and de-identification:** Sensitive metadata columns (`year_of_birth`, `body_product`) are removed before modeling. Sample IDs are pseudonymized.
